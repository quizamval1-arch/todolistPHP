...
<body>
    <main>
        ...
        <form action="insertUser.php" method="POST" class="cont-2">
            ...
            <input class="barra1" type="password" name="confirmContraseña" placeholder="Confirmar contraseña" required>
            <div class="options">
                <button type="submit" class="boton1">Sign up</button>
